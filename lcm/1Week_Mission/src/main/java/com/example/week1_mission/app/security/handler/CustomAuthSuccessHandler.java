package com.example.week1_mission.app.security.handler;


import com.example.week1_mission.app.security.dto.MemberDto;
import com.example.week1_mission.app.util.Ut;
...
public class CustomAuthSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        url = Ut.url.modifyQueryParam(url, "msg", memberDto.getName() + "님 환영합니다.");
