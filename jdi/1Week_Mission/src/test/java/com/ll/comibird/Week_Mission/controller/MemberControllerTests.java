package com.ll.comibird.Week_Mission.controller;

import com.ll.comibird.Week_Mission.app.member.controller.MemberController;
...
public class MemberControllerTests {
    ...
    void t2() throws Exception {
        ...
        assertThat(memberRepository.findByUsername("user999").isPresent()).isTrue();
    }
}
